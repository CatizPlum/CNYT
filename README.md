...
- `complejos.py`: Librería que implementa las funciones de números complejos.
- `test_complejos.py`: Archivo con pruebas automáticas de las funciones.
- `README.md`: Archivo descriptivo del proyecto escrito en Markdown.
- `.gitignore`: Archivos excluidos del control de versiones.

## Funciones implementadas
La librería incluye al menos ocho funciones:
